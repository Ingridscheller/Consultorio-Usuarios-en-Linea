...
public class DAOHistoriaclinica {
    ...
    public ArrayList<TOHistoriaclinica> consultarHistoriasclinicas() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                historiaclinica.setSignosVitales(rs.getString("signosVitales"));
    ...
    public int insertarHistoriasclinicas(TOHistoriaclinica historiaclinica) {
        String[] valores = {String.valueOf(historiaclinica.getIdHistoriaCita()), historiaclinica.getAntecedentes(), historiaclinica.getMotivoConsulta(), historiaclinica.getSignosVitales(), historiaclinica.getDiagnostico(), historiaclinica.getTratamiento(), historiaclinica.getOrdenesMedicas(), historiaclinica.getProximoControl().toString(), historiaclinica.getOrdenLaboratorios(), historiaclinica.getOrdenImagenesDiagnosticas(), String.valueOf(historiaclinica.getIdHistoriaCita())};
        try{
